...
def rag():
    ...
    decisions = [
        _make_decision(id="m1", label="HIGH_RISK",
        ...
        _make_decision(id="m2", label="MEDIUM_RISK",
        ...
        _make_decision(id="m3", label="LOW_RISK",
    ...
    data_loader.get_label_distribution.return_value = {"HIGH_RISK": 1, "MEDIUM_RISK": 1, "LOW_RISK": 1}
...
class TestIntentRouting:
    ...
    def test_fallback_to_search(self, rag):
        ...
        assert "Inga relevanta" in response or "Sokresultat" in response
